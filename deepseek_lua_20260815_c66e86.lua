...
local function chooseAdaptiveCombo()
    ...
    -- Pool: combina combos aprendidos com combos anime (se houver aprendidos, 50/50; senão só anime)
    local pool = {}
    ...
    currentCombo = bestCombo.funcs or fallbackCombos[1]
    currentComboName = bestCombo.name or "Básico"
    comboStep = 1
...
print("🎌 Auto combate com combos de anime + auto parry ultra + observador ativados!")