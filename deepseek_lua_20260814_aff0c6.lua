...
observerFrame.Size = UDim2.new(0, 200, 0, 150)
...
local function resetComboObserver(newTarget)
    ...
    if newTarget then
        statusLabel.Text = "👤 " .. Players:GetPlayerFromCharacter(newTarget).Name
    else
        statusLabel.Text = "Nenhum inimigo"
    end
end
...
local function chooseAdaptiveCombo()
    -- Se houver combos aprendidos, usa eles; senão, usa fallback
